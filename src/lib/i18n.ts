...
const en = {
  ...
  home: {
    ...
    reciteIt: 'Recite it',
    reciteItHint: 'Say it out loud. It listens and lights each word as it comes back.',
    selfCheck: 'Check yourself',
    selfCheckHint: 'Say it from memory, reveal it, and mark how it went. No microphone.',
    onDevice: 'Your voice stays on this device.',
    start: 'Start a round',
  ...
  drill: {
    ...
    listen: {
      ...
      preparingNoSize: 'Getting the listener ready…',
      ready: (n: number) => `Recite ayah ${n} when you are ready.`,
      start: 'Start reciting',
      listening: 'Listening. Each dot lights as a word comes back.',
      done: "I've finished",
      finishing: 'Checking what it heard…',
      onDevice: 'Your voice stays on this device.',
      mic: {
        insecure: 'The microphone only works on a secure page (an https:// address). You can still reveal the ayah and mark it yourself.',
        deniedSite: 'The microphone is blocked for this site. Tap the icon beside the address, open site settings, allow the microphone, then reload.',
        deniedApp: 'Your phone has not given this browser the microphone. Allow it in the phone’s settings (Apps › your browser › Permissions › Microphone), then reload.',
        missing: 'No microphone was found on this device. You can still reveal the ayah and mark it yourself.',
        other: 'The microphone could not start in this browser. If you opened this inside another app, try it in Chrome or Safari.',
      },
      failed: 'The listener could not start on this device. You can still reveal the ayah and mark it yourself.',
      heardNothing: 'It did not catch any words. Mark it yourself below.',
      suggestion: 'Suggested from what it heard. It can mishear, so change it if it is not what you said.',
      dotsLabel: (heard: number, total: number) => `${heard} of ${total} words heard`,
    },
  },
  ...
  footer: {
    ...
    data: 'One anonymous cookie holds your progress, and another remembers your language. No location, no contacts, no tracking, no ads, and nothing sold or shared. If you turn on listening, your voice is processed on your device and never uploaded.',
...
const ar: Dictionary = {
  ...
  home: {
    ...
    reciteIt: 'سمِّعها',
    reciteItHint: 'اتلُها بصوت مسموع، فيستمع ويضيء كل كلمة حين تحضر.',
    selfCheck: 'راجع بنفسك',
    selfCheckHint: 'اتلُها من حفظك، ثم اكشفها وقيّم كيف كانت. دون ميكروفون.',
    onDevice: 'صوتك يبقى على جهازك.',
    start: 'ابدأ جولة',
  ...
  drill: {
    ...
    listen: {
      ...
      preparingNoSize: 'نجهّز المستمع…',
      ready: (n) => `اتلُ الآية ${num(n, 'ar')} متى شئت.`,
      start: 'ابدأ التلاوة',
      listening: 'نستمع. تضيء كل نقطة حين تحضر كلمة.',
      done: 'انتهيت',
      finishing: 'نراجع ما سُمع…',
      onDevice: 'صوتك يبقى على جهازك.',
      mic: {
        insecure: 'الميكروفون يعمل فقط على صفحة آمنة (عنوان يبدأ بـ https://). ما زال بإمكانك كشف الآية وتقييمها بنفسك.',
        deniedSite: 'الميكروفون محجوب عن هذا الموقع. اضغط الرمز بجانب العنوان، وافتح إعدادات الموقع، واسمح بالميكروفون، ثم أعد تحميل الصفحة.',
        deniedApp: 'لم يمنح هاتفك هذا المتصفح إذن الميكروفون. اسمح به من إعدادات الهاتف (التطبيقات › المتصفح › الأذونات › الميكروفون)، ثم أعد تحميل الصفحة.',
        missing: 'لم يُعثر على ميكروفون في هذا الجهاز. ما زال بإمكانك كشف الآية وتقييمها بنفسك.',
        other: 'تعذّر تشغيل الميكروفون في هذا المتصفح. إن فتحت الصفحة من داخل تطبيق آخر، جرّبها في Chrome أو Safari.',
      },
      failed: 'تعذّر تشغيل المستمع على هذا الجهاز. ما زال بإمكانك كشف الآية وتقييمها بنفسك.',
      heardNothing: 'لم يلتقط أي كلمة. قيّمها بنفسك في الأسفل.',
      suggestion: 'اقتراح بناءً على ما سُمع. قد يخطئ السمع، فغيّره إن لم يكن ما قلته.',
      dotsLabel: (heard, total) => `سُمعت ${num(heard, 'ar')} من ${num(total, 'ar')} كلمات`,
    },
  },
  ...
  footer: {
    ...
    dataHeading: 'بياناتك',
    data: 'ملف تعريف مجهول (كوكي) يحفظ تقدّمك، وآخر يتذكّر لغتك. لا موقع، ولا جهات اتصال، ولا تتبّع، ولا إعلانات، ولا يُباع شيء أو يُشارَك. وإن فعّلت الاستماع، يُعالَج صوتك على جهازك ولا يُرفع أبدًا.',
