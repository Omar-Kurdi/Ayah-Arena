...
const en = {
  ...
  drill: {
    ...
    listen: {
      ...
      micBlocked: 'The microphone is not available. You can still reveal the ayah and mark it yourself.',
...
const ar: Dictionary = {
  ...
  drill: {
    ...
    listen: {
      ...
      micBlocked: 'الميكروفون غير متاح. ما زال بإمكانك كشف الآية وتقييمها بنفسك.',
